...
<header class="py-3" style="background: linear-gradient(90deg, rgba(255,107,107,0.2), rgba(124,58,237,0.2));">
    <div class="container d-flex align-items-center justify-content-between">
        <a class="d-flex align-items-center text-white text-decoration-none" href="<?= base_url() ?>">
            <img src="<?= base_url() ?>/assets/3se.png" alt="3 Sud Est" style="height:40px;" />
            <span class="ms-3 fs-5 fw-semibold">Fan site</span>
        </a>
        <nav class="d-none d-md-block">
            <ul class="nav">
                <li class="nav-item"><a class="nav-link text-white" href="<?= base_url() ?>">Acasă</a></li>
                <li class="nav-item"><a class="nav-link text-white" href="<?= base_url() ?>/?page=about">Despre</a></li>
                <li class="nav-item"><a class="nav-link text-white" href="<?= base_url() ?>/?page=members">Membri</a></li>
                <li class="nav-item"><a class="nav-link text-white" href="<?= base_url() ?>/?page=news">Știri</a></li>
